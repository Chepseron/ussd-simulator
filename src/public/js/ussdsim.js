$(document).ready(function() {
    ...
    function sendRequest() {
        ...
        console.log($("#endpoint").val().concat("/ussd/").concat($("#msisdn").val()).concat("/12313213213213/203/").concat($("#input").val()));
        currentRequest = $.ajax({
            url: $("#endpoint").val().concat("/ussd/").concat($("#msisdn").val()).concat("/12313213213213/203/").concat($("#input").val()),
            type: 'GET',
    ...
    function cancelRequest(sendCancelRequest = true) {
        ...
        if (sendCancelRequest) {
             ...
             */
            currentRequest = $.post(SIMULATOR_USSD_API_ENDPOINT);
